...
/**
 * Test case for class Interain\Interform\Controller\EventController.
 *
...
class EventControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \Interain\Interform\Controller\EventController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('Interain\\Interform\\Controller\\EventController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function showActionAssignsTheGivenEventToView() {
		$event = new \Interain\Interform\Domain\Model\Event();
	...
	public function createActionAddsTheGivenEventToEventRepository() {
		...
		$eventRepository = $this->getMock('Interain\\Interform\\Domain\\Repository\\EventRepository', array('add'), array(), '', FALSE);
